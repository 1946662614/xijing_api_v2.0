...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "xijing";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        // 使用 synchronized 关键字对 userAccount.intern() 进行同步，确保并发情况下的线程安全
        synchronized (userAccount.intern()) {
            ...
            /**
             * 需要注意的是，代码中的 user.getId() 使用了 MyBatis-Plus 的 @TableId(type = IdType.ASSIGN_ID) 注解，
             * 表示自动生成主键，所以在保存用户信息后可以直接获取到用户的主键 ID。
             */
            return user.getId();
        }
    }
